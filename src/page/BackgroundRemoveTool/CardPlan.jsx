...
const CardPlan = () => {
  return (
    <section className="card-plan py-16 2xl:px-[158px] md:px-15 px-5 xl:flex xl:gap-12 block">
      {/* Left Info Section */}
      <div className="w-full xl:max-w-[588px] flex items-center justify-center xl:justify-start">
        <div className="space-y-4 text-center xl:text-left">
          ...
          <ul className="md:mt-4 mt-7.5 space-y-6 md:space-y-8">
            {[
      ...
      {/* Right Cards Section */}
      <div className="lg:flex block gap-5 w-full xl:justify-end justify-center mt-10 card-main">
        {/* Trial Card */}
        <div className="lg:w-[354px] gap-0  w-full bg-white shadow-lg rounded-xl sm:p-7.5 p-3  relative flex flex-col  lg:!h-[495px] h-full xs:h-full">
          ...
          <h3 className="text-[var(--doubelblack)] text-[26px] font-medium leading-7.5 !pt-[91px] !pb-2">07 Days Trial</h3>
          ...
          <p className="text-[var(--paragraphtitle)] text-base leading-6.5 font-medium !mb-5">
          ...
          {/* SAME BUTTON DESIGN */}
          <button className=" text-base font-bold leading-4.5 py-3.5 border border-[var(--btnbg)] text-[var(--btnbg)] px-4  rounded-lg hover:bg-purple-50 transition">
            Sign Up
          </button>
        </div>

        {/* Subscription Plan Card */}
        <div className="lg:w-[354px] w-full lg:mt-0 mt-5 bg-white shadow-lg rounded-xl sm:p-7.5 p-3 flex flex-col justify-between lg:!h-[495px] h-full xs:h-full">
          {/* <div> */}
            <h3 className="text-[var(--doubelblack)] font-medium !mb-2 text-[26px] leading-7.5">Subscription Plan</h3>
