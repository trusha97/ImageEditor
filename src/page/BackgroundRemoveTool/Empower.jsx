                ...
                <div className="max-w-[1398px] mx-auto xl:flex block gap-5 sm:pt-22.5 pt-10 xl:pb-24 pb-10 px-4">
                    <div className="xl:w-[60%] w-full">
                        ...
                        <div className="xl:hidden block">
                            <button
                                type="button"
                                className=" xl:mx-0 sm:mx-auto mx-0  mb-7.5 px-8.5 py-3.5 rounded-[var(--radius)] bg-[var(--btnbg)] flex items-center gap-[6px] cursor-pointer text-[var(--white)] font-bold text-base leading-5 "
                            >
                                Let’s Get Start
                                <svg
                    ...
                    <div className="xl:w-[40%] w-full">
                        ...
                        <div className="xl:block hidden">
                            <button
                                type="button"
                                className="px-8.5 py-3.5 rounded-[var(--radius)] bg-[var(--btnbg)] flex items-center gap-[6px] cursor-pointer text-[var(--white)] font-bold text-base leading-5 "
                            >
                                Let’s Get Start
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
